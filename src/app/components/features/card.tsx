  ...
  return (
    <div
      className={clsx(
        ...
        inViewFeature === id ? "active-card opacity-100" : "pointer-events-none opacity-0"
      )}
    >
      <div className={clsx("gradient absolute inset-0 origin-bottom-left rounded-2xl bg-gradient-to-br", gradient)} />
      {children}
      <button
    ...
    <FeatureCard id={id} gradient="from-[#f7fff5] to-[#adffd8]">
      ...
      {!isFullscreen && (
        <motion.div
          ...
          className="absolute left-[40%] top-[20%] h-[44%] w-[22%] rounded-[96px] bg-[#1bd761] shadow-lg sm:p-2 md:p-2 lg:p-3"
        >
